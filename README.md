...
- **The daily brief** — your first Claude session of the day opens with two
  lines: yesterday's time/token anatomy and the week so far. Rendered from a
  local cache (zero startup latency, works offline-quiet). Tune with
