-- Oh v0 — shared Team Brain (Supabase / Postgres + pgvector)
-- Mirror of src/schema.ts (canonical). Run once in the Supabase SQL editor,
-- or `oh migrate --db-url <postgres-connection-string>`.
